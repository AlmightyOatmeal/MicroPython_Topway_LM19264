# Yoinked from https://github.com/Emantor/mensactrl/blob/master/python/bitmapfont.py
# which was yoinked from http://www.hwsw.no/snippets/5x7_LCD_font.php
FONT_5x7 = {
